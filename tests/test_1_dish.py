...
class TestGetAllDishes:
    ...
    async def test_dish_get_empty_list(
        self,
        client: AsyncClient,
        menu: Menu,
        submenu: Submenu
...
class TestCreateDish:
    async def test_dish_post_status(
        self,
        client: AsyncClient,
        menu: Menu,
        submenu: Submenu
    ...
    async def test_dish_post_object_created(
        self,
        client: AsyncClient,
        menu: Menu,
        submenu: Submenu
    ...
    async def test_dish_post_price(
        self,
        client: AsyncClient,
        menu: Menu,
        submenu: Submenu
...
class TestGetDish:
    ...
    async def test_dish_get_status(
        self,
        client: AsyncClient,
        menu: Menu,
        submenu: Submenu,
    ...
    async def test_dish_get_if_menu_404(
        self,
        client: AsyncClient,
        menu: Menu,
        submenu: Submenu,
    ...
    async def test_dish_get_submenu_id(
        self,
        client: AsyncClient,
        menu: Menu,
        submenu: Submenu,
...
class TestUpdateDish:
    ...
    async def test_dish_patch_status(
        self,
        client: AsyncClient,
        menu: Menu,
        submenu: Submenu,
    ...
    async def test_dish_patch_price(
        self,
        client: AsyncClient,
        menu: Menu,
        submenu: Submenu,
...
class TestDeleteDish:
    ...
    async def test_dish_delete_status(
        self,
        client: AsyncClient,
        menu: Menu,
        submenu: Submenu,
    ...
    async def test_dish_delete_404(
        self,
        client: AsyncClient,
        menu: Menu,
        submenu: Submenu
